    ...
    <div style={pageWrap}>
      ...
      <section style={mainGrid}>
        ...
        <div style={rightColumn}>
          ...
          <div style={sideCard}>
            <p style={sideTag}>NEXT BUILD</p>
            <h3 style={sideTitle}>Recommended Upgrades</h3>

            <div style={upgradeList}>
              <div style={upgradeItem}>Add donor photos upload</div>
              <div style={upgradeItem}>Build public donor listing</div>
              <div style={upgradeItem}>Create blood request approval flow</div>
              <div style={upgradeItem}>Generate beautiful thank-you cards</div>
            </div>
          </div>

          <div style={sideCardHighlight}>
            <p style={sideTagLight}>PREMIUM NOTE</p>
            <h3 style={highlightTitle}>Your admin panel is now live</h3>
            <p style={highlightText}>
              The role-based admin login is working correctly, and this dashboard
              is ready for the next features like donor management, requests,
              media uploads, and appreciation tools.
            </p>
          </div>
        </div>
      </section>
...
const sideCardHighlight: React.CSSProperties = {
  background: "linear-gradient(135deg, #7f1d1d 0%, #b91c1c 48%, #ef4444 100%)",
  borderRadius: "26px",
  padding: "24px",
  color: "#fff",
  boxShadow: "0 20px 50px rgba(127, 29, 29, 0.18)",
};
...
const sideTagLight: React.CSSProperties = {
  margin: 0,
  color: "rgba(255,255,255,0.74)",
  fontSize: "12px",
  fontWeight: 800,
...
const upgradeList: React.CSSProperties = {
  display: "flex",
  flexDirection: "column",
  gap: "12px",
};
